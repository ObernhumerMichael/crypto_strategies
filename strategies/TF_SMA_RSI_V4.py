...
class TF_SMA_RSI_V4(IStrategy):
    ...
    atr_buy_multiplier = 7
    atr_sell_multiplier = 14
    atr_length = 14
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe[f"stoploss_percent"] = (
            dataframe["atr"] / dataframe["close"] * self.atr_buy_multiplier * -1
        )

        dataframe[f"roi_percent"] = (
            dataframe["atr"] / dataframe["close"] * self.atr_sell_multiplier
        )
        return dataframe
