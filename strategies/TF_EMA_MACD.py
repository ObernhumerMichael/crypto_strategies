...
class TF_EMA_MACD(IStrategy):
    ...
    # Strategy parameters
    buy_ema_short = IntParameter(3, 100, default=5)
    buy_ema_long = IntParameter(15, 300, default=20)
    adx_guard = 25
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # for plotting
        dataframe[f"ema_short"] = ta.SMA(dataframe, timeperiod=self.buy_ema_short.value)
        dataframe[f"ema_long"] = ta.SMA(dataframe, timeperiod=self.buy_ema_long.value)
