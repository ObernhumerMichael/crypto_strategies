...
class TF_SMA_RSI_V3(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # Guard
        conditions_long.append(dataframe["rsi"] > self.rsi_border)
        conditions_long.append(dataframe["rsi"] < self.rsi_upper_bound)
        conditions_long.append(dataframe["volume"] > 0)

        if conditions_long:
            dataframe.loc[
                reduce(lambda x, y: x & y, conditions_long), ["enter_long", "enter_tag"]
            ] = (1, "enter_long")
        ...
        # Guard
        conditions_short.append(dataframe["rsi"] < self.rsi_border)
        conditions_short.append(dataframe["rsi"] > self.rsi_lower_bound)
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # Guard
        conditions_long.append(dataframe["rsi"] < self.rsi_border)
        conditions_long.append(dataframe["rsi"] > self.rsi_lower_bound)
        conditions_long.append(dataframe["volume"] > 0)

        if conditions_long:
            dataframe.loc[
                reduce(lambda x, y: x & y, conditions_long), ["exit_long", "exit_tag"]
            ] = (1, "close_long")
        ...
        # Guard
        conditions_short.append(dataframe["rsi"] > self.rsi_border)
        conditions_short.append(dataframe["rsi"] < self.rsi_upper_bound)
        conditions_short.append(dataframe["volume"] > 0)
